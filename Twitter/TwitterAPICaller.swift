...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "9Zq98W6oAguMaQDfLRPLovaoG", consumerSecret: "OrehmVqdrSZw6K6Ut7UkGA3tf8DhbFBwnigNINDZVJr8QkIATP")
    var loginSuccess: (() -> ())?
